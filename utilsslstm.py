...
class DataLoader():
    ...
    def __init__(self, batch_size=50, seq_length=5, datasets=[0, 1], forcePreProcess=False, infer=False):
        ...
        self.data_dirs = ['/home/nesli/keypointdetection/input/training/'] #'/home/nesli/keypointdetection/input/training/']
                          #,'/home/neslihan/trajectory_maneuver_prediction-tp2/data/lyft_new/val']

        self.used_data_dirs = [self.data_dirs[x] for x in datasets] #Only training dataset is stored. Check if meaningful.
        self.infer = infer

        # Number of datasets
        self.numDatasets = len(self.data_dirs) #3 --> This information is not used anywhere.

        # Data directory where the pre-processed pickle file resides (i.e. trajectories.cpkl)
        #self.data_dir = './data'
        self.data_dir = '/home/nesli/keypointdetection/data/'
        ...
        self.reset_batch_pointer(valid=True) #Why two times reset with valid=False, valid=True?
    ...
    def frame_preprocess(self, data_dirs, data_file):
        ...
        for directory in data_dirs:
            ...
            #file_path = os.path.join(directory, 'pixel_pos_interpolate1.csv') #original pixel_pos_interpolate.csv
            file_path = '/home/nesli/keypointdetection/input/lane_change_23_88456.csv'
    ...
    def load_preprocessed(self, data_file):
        ...
        print('Total number of validation batches:', self.valid_num_batches) #Why don't we multiply with 2?
        # On an average, we need twice the number of batches to cover the data
        # due to randomization introduced --> did not understand this part of the code!
    ...
    def next_batch(self, randomUpdate=True):
        ...
        while i < self.batch_size:
            ...
            frameID = self.frameList[self.dataset_pointer]
