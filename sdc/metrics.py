...
class SDCLoss:
    def __init__(self, full_model_name, c):
        ...
        #   M = number of datapoints in evaluation set --> does it mean number of request?
        ...
        # Path where retention (both standard and fbeta) results are stored #IMPORTANT!!
        metrics_dir = (
        ...
        # See `sdc.oatomobile.torch.baselines.robust_imitative_planning.py` #IMPORTANT!!
