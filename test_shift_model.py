...
def trajectories_plot_shift(image, outputs, targets, j, ade, fde, output_list, outputs_var_mean, final_index):
    ...
    ax1.imshow(image[0, 9, :, :], origin='lower', cmap='binary', alpha=0.7)
    ax1.imshow(image[0, 19, :, :], origin='lower', cmap='binary', alpha=0.5)
    ax1.imshow(image[0, 24, :, :], origin='lower', cmap='binary', alpha=0.2)
    ax1.imshow(image[0, 27, :, :], origin='lower', cmap='binary', alpha=0.1)
